...
public class List {
    ...
    **/
    ...
    //
    // declare a private int size again, don't initialize it here variable
    // initialization should be done in the constructor
    /**
    declaring an size integer.
    **/
    private int size;
     ...
     * is to announce the size of the list to the objects outside the list The
     * method returns an int. Empty list should return 0.
     *
